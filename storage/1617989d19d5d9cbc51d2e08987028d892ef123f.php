        ...
        <table class="table table-bordered">
            ...
            <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><?php echo e($acc->role); ?></td>
                    <td>
                        <a href="./index.php?act=update_tk&id=<?php echo e($acc->id); ?>"><input type='button' value='Sửa' style='width:120px; margin:5px; border:none;' disabled><input type='button' value='Sửa' style='width:120px; margin:5px; border:none;'></a> 
                        <a href="./index.php?act=xoatk&id=<?php echo e($acc->id); ?>"><input type="button" value="Xóa" style="width:120px;margin:5px; border:none;"></a>
                    </td>
                </tr>
...
</div><?php /**PATH D:\xampp\htdocs\php2_asm\app\views\admin/accounts/accounts.blade.php ENDPATH**/ ?>