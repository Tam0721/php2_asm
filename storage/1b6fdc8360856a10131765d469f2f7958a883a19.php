						...
						<form class="row login_form requires-validation" action="index.php?url=signup" method="post" id="contactForm" novalidate="novalidate" >
							...
							<div class="col-md-12 form-group">
								<div class="creat_account form-check">
									...
									<div class="invalid-feedback">Vui lòng xác nhận đồng ý các điều khoản sử dụng!</div>
	...
	<!--================End Login Box Area =================--><?php /**PATH C:\xampp\htdocs\PHP2\php2_asm\app\views/account/signup.blade.php ENDPATH**/ ?>