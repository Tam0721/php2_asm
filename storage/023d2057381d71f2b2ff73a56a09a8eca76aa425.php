    ...
    <div class="col d-flex justify-content-center">
					<div class="login_form_inner" style="width:60%;">
						<h3>Tạo tài khoản</h3>
						<form class="row login_form" action="index.php?act=addadmin" method="post" id="contactForm" novalidate="novalidate">
							...
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="ho_ten" placeholder="Họ tên" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Họ tên'" required>
							</div>
							<div class="col-md-12 form-group">
							...
							<!--  -->
							<div class="col-md-12 form-group">
								<input type="submit" value="Thêm mới" class="primary-btn" name="add-admin"></input>
	...
	<!--================End Login Box Area =================-->
<?php /**PATH C:\xampp\htdocs\PHP2\php2_asm\app\views\admin/accounts/add.blade.php ENDPATH**/ ?>