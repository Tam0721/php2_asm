						...
						<div class="col-lg-3 col-md-6">
							<div class="single-product">
								<a href="index.php?url=sanphamct&idsp=<?php echo e($sp->id); ?>">
									<img class="img-fluid" src="upload/<?php echo e($sp->img); ?>" alt="" style="height:270px; width:260;">
								</a>
		...
		<div class="container">
			...
			<div style="
				...
				<?php $__currentLoopData = $listItem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<?php if($sp->special == 1): ?>
						<a href="index.php?url=sanphamct&idsp=<?php echo e($sp->id); ?>">
							<img class="special-img" class="img-product" src="upload/<?php echo e($sp->img); ?>" alt="" width="30%">
						</a>
						...
						<?php $__currentLoopData = $listItem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="col-lg-4 col-md-4 col-sm-6 mb-20">
								<div class="single-related-product d-flex" id="imgTop">
									<a href="index.php?url=sanphamct&idsp=<?php echo e($sp->id); ?>">
										<img src="upload/<?php echo e($sp->img); ?>" alt="">
									</a>
									<div class="desc">
