							...
							<div class="col-lg-5 col-md-6">
								<div class="banner-content">
									...
									<div class="add-bag d-flex align-items-center">
										<a class="add-btn" href="index.php?url=category&iddm=36"><span class="lnr lnr-move"></span></a>
										<a href="index.php?url=category&iddm=36"><span class="add-text text-uppercase">Xem sản phẩm</span></a>
									</div>
								</div>
							</div>
							<div class="col-lg-7">
								<div class="banner-img">
									<a href="index.php?url=category&iddm=36"><img class="img-fluid" src="img/banner/banner-img.png" alt=""></a>
								</div>
							</div>
						</div>
						<!-- single-slide -->
	...
	<section class="owl-carousel active-product-area section_gap">
		...
		<div class="single-product-slider">
			<div class="container">
				...
				<div class="row">
					<?php $__currentLoopData = $listItem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<div class="col-lg-3 col-md-6">
							<div class="single-product">
								<a href="index.php?url=sanphamct&idsp=<?php echo e($sp->id); ?>">
									<img class="img-fluid" src="./public/upload/<?php echo e($sp->img); ?>" alt="" style="height:270px; width:260;">
								</a>
								<div class="product-details">
									...
									<form action="index.php?url=cartprocess" method="post">
										...
										<input type="hidden" name="name" value="<?php echo e($sp->name); ?>">
										<input type="hidden" name="price" value="<?php echo e($price_1); ?>">
										<input type="hidden" name="img" value="<?php echo e($sp->img); ?>">
		...
		<div class="container">
			...
			<div style="
				...
				<?php $__currentLoopData = $listItem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<?php if($sp->special == 1): ?>
						<a href="index.php?url=sanphamct&idsp=<?php echo e($sp->id); ?>">
							<img class="special-img" class="img-product" src="./public/upload/<?php echo e($sp->img); ?>" alt="" width="30%">
						</a>
						<div class="infor-recipe1">
							<h1 style="color:white"><?php echo e($sp->name); ?></h1>
							 <?php if($sp->price_new > 0): ?> 
								<h2 style="color:red;"><?php echo e(number_format($sp->price_new, 0, '.', '.')); ?>.000₫</h2>
								<h4 style="color:black; text-decoration:line-through;"><?php echo e(number_format($sp->price_old, 0, '.', '.')); ?>.000₫</h4>
							<?php else: ?>
								<h2 style="color:red"><?php echo e(number_format($sp->price_old, 0, '.', '.')); ?>.000₫</h2>
							<?php endif; ?>
							<p><?php echo e($sp->mota); ?></p>
							<a href="index.php?url=sanphamct&idsp=<?php echo e($sp->id); ?>"><button class="boujee-text">Xem thêm</button></a>			
						</div>
					<?php endif; ?>
				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			</div>
						...
						<?php $__currentLoopData = $listItem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="col-lg-4 col-md-4 col-sm-6 mb-20">
								<div class="single-related-product d-flex" id="imgTop">
									<a href="index.php?url=sanphamct&idsp=<?php echo e($sp->id); ?>">
										<img src="./public/upload/<?php echo e($sp->img); ?>" alt="">
									</a>
									<div class="desc">
	...
	<style>
	   ...
	   <?php /**PATH C:\xampp\htdocs\PHP2\php2_asm\app\views/home/home.blade.php ENDPATH**/ ?>