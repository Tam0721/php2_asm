        ...
        <table class="table table-bordered">
            ...
            @foreach ($accounts as $acc)
                <tr>
                    ...
                    <td>{{$acc->role}}</td>
                    <td>
                        <a href="./index.php?act=update_tk&id={{$acc->id}}"><input type='button' value='Sửa' style='width:120px; margin:5px; border:none;' disabled><input type='button' value='Sửa' style='width:120px; margin:5px; border:none;'></a> 
                        <a href="./index.php?act=xoatk&id={{$acc->id}}"><input type="button" value="Xóa" style="width:120px;margin:5px; border:none;"></a>
                    </td>
                </tr>
             @endforeach
            <?php
