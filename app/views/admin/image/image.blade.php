    ...
    <div class="table-responsive-sm">
        ...
        <table class="table table-bordered">
            ...
            @foreach ($listImages as $hinhanh) 
                ...
                <tbody>
                    <tr>
                        <td class="text-center"><img src='../public/upload/{{$hinhanh->img}}' width='10%'></td>
                        <td class="text-center">
                            <a href="./index.php?act=deleteimg&id={{$hinhanh->id}}"><input type="button" value="Xóa" style="width:120px;margin:5px; border:none;"></a>
                        </td>
                    </tr>
                </tbody>
            @endforeach
